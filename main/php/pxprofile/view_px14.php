...
<head>
  ...
  <style>
  .form-label {
    margin-bottom: 0.4rem; /* tighter space under labels */
  }
  ...
  <div class="container">
    <div class="card mb-3 shadow-sm">
      <div class="card-body">
        ...
        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 100px;">Age:</div>
          <div class="flex-grow-1">
            <span id="mobile_age_container">
              <span id="mobile_age"></span>
            </span>
          </div>
        </div>
    ...
    <div id="edit_form_view" class="d-none d-md-block">
      ...
      <!-- Row: Name Fields -->
<!-- Row: Name Fields with PWD for desktop -->
<div class="row mb-3">
  <div class="col-md-3">
    <label for="viewpx_fname" class="form-label"><span class="asterisk">*</span> First Name:</label>
    <input type="text" class="form-control" id="viewpx_fname" autocomplete="off">
  </div>
  <div class="col-md-3">
    <label for="viewpx_mname" class="form-label">Middle Name:</label>
    <input type="text" class="form-control" id="viewpx_mname" autocomplete="off">
  </div>
  <div class="col-md-3">
    <label for="viewpx_lname" class="form-label"><span class="asterisk">*</span> Last Name:</label>
    <input type="text" class="form-control" id="viewpx_lname" autocomplete="off">
  </div>

  <!-- Suffix -->
  <div class="col-md-1-5">
    <label for="viewpx_suffix" class="form-label">Suffix:</label>
  ...
  <!-- PWD Checkbox with Label Only -->
  <div class="col-md-1-5 d-flex align-items-end">
    <div class="form-check mt-2">
      <input class="form-check-input" type="checkbox" id="viewpx_is_pwd">
      <label class="form-check-label" for="viewpx_is_pwd">
        PWD
      </label>
    </div>
  </div>
      ...
      <div class="row mb-3">
        <div class="col-12 col-md-4">
          <label for="viewpx_dob" class="form-label">Date of Birth:</label>
          <input type="text" class="form-control" id="viewpx_dob" autocomplete="off" placeholder="YYYY-MM-DD">
        </div>
        <div class="col-12 col-md-4">
          <label for="viewpx_gender" class="form-label">Gender:</label>
        ...
        <div class="col-12 col-md-4">
          <label for="viewpx_civstat" class="form-label">Civil Status:</label>
      ...
      <div class="row mb-3">
        <div class="col-12 col-md-6">
          <label for="viewpx_cellnum" class="form-label">Cellphone number:</label>
        ...
        <div class="col-12 col-md-6">
          <label for="viewpx_emailadd" class="form-label">Email address:</label>
      ...
      <div class="row mb-3 align-items-end">
        <div class="col-md-12 col-sm-12 mb-2">
          <label for="viewpx_addr" class="form-label">Address:</label>
      ...
      <div class="row mb-3">
        <div class="col-12 col-md-6">
          <label for="viewpx_hmo" class="form-label">HMO Provider:</label>
        ...
        <div class="col-12 col-md-6">
          <label for="viewpx_company" class="form-label">Company Name:</label>
