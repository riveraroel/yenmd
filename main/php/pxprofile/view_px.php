...
<!-- Image Viewer Modal -->
<div class="modal fade viewer-modal" id="imageModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      
      <!-- Header -->
      <div class="modal-header d-flex justify-content-between align-items-center" style="padding: 0.3rem 0.8rem;">
        <h5 class="modal-title mb-0">Image Viewer</h5>
        <div class="d-flex align-items-center gap-2">
          <a id="imageDownload" href="#" download
             ...
             data-bs-toggle="tooltip" data-bs-placement="bottom" title="Download Image">
          ...
          <button type="button"
                  ...
                  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Close Viewer">
            <i class="bi bi-x-lg"></i>
          </button>
        </div>
      </div>
...
<!-- PDF Modal -->
<div class="modal fade viewer-modal" id="pdfModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">

      <!-- Header -->
      <div class="modal-header d-flex justify-content-between align-items-center" style="padding: 0.3rem 0.8rem;">
        <h5 class="modal-title mb-0">PDF Viewer</h5>
        <div class="d-flex align-items-center gap-2">
          <a id="pdfDownload" href="#" download
             class="btn btn-light btn-sm d-flex align-items-center justify-content-center"
             style="border-radius: 50%; width: 32px; height: 32px;"
