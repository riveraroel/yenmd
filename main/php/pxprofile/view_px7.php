    ...
    <form id="viewpx-form">
      ...
      <div class="container mt-3">
        <div class="row d-flex justify-content-start gap-1">
          <div class="col-12 d-md-inline col-md-auto">
        ...
        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
            <div class = 'container mt-4'>
                <div class = 'col-12'>
                    ...
                    <table id="tb_medhistory" class="table table-striped table-hover table-sm w-100" style="width:100%">
                        <thead>
                            <tr>
                                <th>Diagnosis</th>
                                <th>Lab Results</th>
  ...
  ?>
        ...
        <div class="tab-pane fade" id="nav-pres" role="tabpanel" aria-labelledby="nav-pres-tab" tabindex="0">
            <div class = 'container mt-4'>
                <div class = 'col-12'>
                    <div class="table-responsive">
                        <table id="tb_pres_history" class="table table-striped table-hover table-sm w-100" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Prescription</th>
                                    <th>Issued by</th>
        ...
        <div class="tab-pane fade" id="nav-appointment" role="tabpanel" aria-labelledby="nav-appointment-tab" tabindex="0">
            <div class = 'container mt-4'>
                <div class = 'col-12'>
                    <div class="table-responsive">
                    <table id="tb_apt_history" class="table table-striped table-hover table-sm w-100" style="width:100%">
                        <thead>
                            <tr>
                                <th>Reason</th>
                                <th>Issued by</th>
