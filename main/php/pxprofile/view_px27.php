...
<div class="sticky-top bg-white" style="z-index: 1020;">
  ...
  <span class="d-inline d-sm-none"> Uploads</span>
  <span class="d-none d-sm-inline"> Uploaded Images</span>
</button>
...
<div class="row mb-3">
  <div class="col-12">
    ...
    <div style="position:relative;">
      <textarea class="form-control" id="labresult" rows="5" placeholder="Start typing test name..."></textarea>
