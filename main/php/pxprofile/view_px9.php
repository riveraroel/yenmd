    ...
    <div class="card mb-3 shadow-sm">
      <div class="card-body">
        ...
        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 120px;">Full Name:</div>
          <div class="flex-grow-1" id="mobile_fullname"></div>
        </div>

        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 120px;">Date of Birth:</div>
          <div class="flex-grow-1" id="mobile_dob"></div>
        </div>

        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 120px;">Age:</div>
          <div class="flex-grow-1" id="mobile_age"></div>
        </div>

        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 120px;">Gender:</div>
          <div class="flex-grow-1" id="mobile_gender"></div>
        </div>

        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 120px;">Civil Status:</div>
          <div class="flex-grow-1" id="mobile_civstat"></div>
        </div>

        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 120px;">Cellphone:</div>
          <div class="flex-grow-1" id="mobile_cellnum"></div>
        </div>

        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 120px;">Email:</div>
          <div class="flex-grow-1" id="mobile_emailadd"></div>
        </div>

        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 120px;">Address:</div>
          <div class="flex-grow-1" id="mobile_addr"></div>
        </div>

        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 120px;">HMO:</div>
          <div class="flex-grow-1" id="mobile_hmo"></div>
        </div>

        <div class="d-flex mb-1">
          <div class="me-2 text-end fw-bold" style="min-width: 120px;">Company:</div>
    ...
    <div class="col-12">
      ...
      <div class="d-md-none">
        <?php if (empty($labTests)): ?>
          <div class="alert alert-info text-center">No lab test history found</div>
        <?php else: ?>
          <?php $counter = 1; ?>
          <?php foreach ($labTests as $test): ?>
