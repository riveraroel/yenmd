...
if (
    ...
    echo "No changes detected. Update aborted.";
    exit;
}
...
$pdf->Image($image_path, (148 - 91.1458) / 2, 5, 91.1458, 26.4583);
...
echo "Lab test request updated and PDF regenerated successfully.";
