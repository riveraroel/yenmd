<div class="tab-pane fade justify-content-center" id="pills-px_profile" role="tabpanel" aria-labelledby="pills-px_profile-tab">
    ...
    <form id="addpx-form" class="container py-3">
        <div class="row mb-3">
            <div class="col-md-3 col-sm-6 mb-2">
                ...
                <input type="text" class="form-control" id="addpx_fname" autocomplete="off" required>
            </div>
            <div class="col-md-3 col-sm-6 mb-2">
            ...
            <div class="col-md-3 col-sm-6 mb-2">
                ...
                <input type="text" class="form-control" id="addpx_lname" autocomplete="off" required>
            </div>
            <div class="col-md-3 col-sm-6 mb-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-sm-6 mb-2">
                <label for="addpx_gender">Gender:</label>
                <select class="form-select" id="addpx_gender">
            ...
            <div class="col-md-4 col-sm-6 mb-2">
                ...
                <select class="form-select" id="addpx_civstat">
                    <option value="None" selected disabled>Select here...</option>
        ...
        <div class="row mb-3">
            <div class="col-md-6 col-sm-12 mb-2">
                ...
                <input type="tel" class="form-control" id="addpx_cellnum" autocomplete="off" placeholder="09XXXXXXXXX">
            </div>
            <div class="col-md-6 col-sm-12 mb-2">
        ...
        <div class="col-md-3 col-sm-6 mb-2">
            ...
            <label class="form-check-label" for="addpx_is_pwd">
                PWD
            </label>
            </div>
        </div>
  ...
  <button type="button" id="submit_px" class="btn btn-outline-primary btn-lg w-100 w-md-auto">Submit</button>
</div>
