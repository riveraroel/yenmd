...
if (empty($uploadImages)) {      
    echo '<div class="d-md-none"><div class="alert alert-info text-center mb-0">No lab results uploaded yet</div></div>';
    echo '
<div class="d-none d-md-flex justify-content-center align-items-center flex-column" style="height: 300px; background-color: #f8f9fa; border: 2px dashed #ccc;">
  ...
  <p class="text-muted fs-5 mb-0">No lab results uploaded yet</p>
</div>';
  exit;
}
  ...
  <div class="card shadow-sm h-100 <?= $cardClass ?>">
    <?php if ($isPDF): ?>
      ...
      <div class="d-flex align-items-center justify-content-center bg-light"
           ...
           data-pdf="<?= $basePath ?>/main/php/<?= $img['path'] ?>"
