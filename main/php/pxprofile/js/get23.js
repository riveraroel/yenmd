...
const referenceData = {
  CALCIUM: {
    conventional: { min: 8.40, max: 10.20, unit: "MG/DL" },
    si:           { min: 2.10, max: 2.55, unit: "MMOL/L" }
  },
  GGTP: {
    conventional: { min: 7.00, max: 32.00, unit: "U/L" },
    si:           { min: 7.00, max: 32.00, unit: "U/L" }
  },
  PHOSPHORUS: {
    conventional: { min: 2.51, max: 4.50, unit: "MG/DL" },
    si:           { min: 0.81, max: 1.45, unit: "MMOL/L" }
  },
  AMYLASE: {
    conventional: { min: 28.00, max: 100.00, unit: "U/L" },
    si:           { min: 28.00, max: 100.00, unit: "U/L" }
  },
  'CK TOTAL': {
    conventional: { min: 0.00, max: 170.00, unit: "U/L" },
    si:           { min: 0.00, max: 170.00, unit: "U/L" }
  },
  HBA1C: {
    conventional: { min: 4.00, max: 5.99, unit: "%" },
    si:           { min: 4.00, max: 5.99, unit: "%" }
  },
  FBS: {
    conventional: { min: 60.00, max: 99.00, unit: "MG/DL" },
    si:           { min: 3.30, max: 5.50, unit: "MMOL/L" }
  },
  BUN: {
    conventional: { min: 4.76, max: 23.25, unit: "MG/DL" },
    si:           { min: 1.70, max: 8.30, unit: "MMOL/L" }
  },
  CREATININE: {
    conventional: { min: 0.50, max: 1.00, unit: "MG/DL" },
    si:           { min: 44.20, max: 88.40, unit: "MMOL/L" }
  },
  'URIC ACID': {
    conventional: { min: 2.50, max: 6.80, unit: "MG/DL" },
    si:           { min: 149.00, max: 405.00, unit: "MMOL/L" }
  },
  CHOLESTEROL: {
    conventional: { min: 0.00, max: 200.00, unit: "MG/DL" },
    si:           { min: 0.00, max: 5.20, unit: "MMOL/L" }
  },
  TRIGLYCERIDES: {
    conventional: { min: 35.00, max: 160.00, unit: "MG/DL" },
    si:           { min: 0.39, max: 1.76, unit: "MMOL/L" }
  },
  'HDL CHOLE': {
    conventional: { min: 40.00, max: 60.00, unit: "MG/DL" },
    si:           { min: 1.04, max: 1.55, unit: "MMOL/L" }
  },
  'LDL CHOLE': {
    conventional: { min: 0.00, max: 100.00, unit: "MG/DL" },
    si:           { min: 0.00, max: 2.59, unit: "MMOL/L" }
  },
  SGOT: {
    conventional: { min: 0.00, max: 32.00, unit: "U/L" },
    si:           { min: 0.00, max: 32.00, unit: "U/L" }
  },
  SGPT: {
    conventional: { min: 0.00, max: 31.00, unit: "U/L" },
    si:           { min: 0.00, max: 31.00, unit: "U/L" }
  },                
  LDH: {
    conventional: { min: 135.00, max: 225.00, unit: "U/L" },
    si:           { min: 135.00, max: 225.00, unit: "U/L" }
  },
  'ALK PHOS': {
    conventional: { min: 40.00, max: 129.00, unit: "U/L" },
    si:           { min: 40.00, max: 129.00, unit: "U/L" }
  },
  SODIUM: {
    conventional: { min: 136.00, max: 145.00, unit: "mEq/L" },
    si:           { min: 136.00, max: 145.00, unit: "MMOL/L" }
  },
  POTASSIUM: {
    conventional: { min: 3.50, max: 5.10, unit: "mEq/L" },
    si:           { min: 3.50, max: 5.10, unit: "MMOL/L" }
  },
  CHLORIDE: {
    conventional: { min: 98.00, max: 111.00, unit: "mEq/L" },
    si:           { min: 98.00, max: 111.00, unit: "MMOL/L" }
  },
  'TOTAL PROTEIN': {
    conventional: { min: 6.40, max: 8.30, unit: "GM/DL" },
    si:           { min: 64.00, max: 83.00, unit: "GM/L" }
  },
  ALBUMIN: {
    conventional: { min: 3.40, max: 4.80, unit: "GM/DL" },
    si:           { min: 34.00, max: 48.00, unit: "GM/L" }
  },
  GLOBULIN: {
    conventional: { min: 2.00, max: 3.50, unit: "GM/DL" },
    si:           { min: 20.00, max: 35.00, unit: "GM/L" }
  },
  'A/G RATIO': {
    conventional: { min: 1.00, max: 2.50, unit: "" },
    si:           { min: 1.00, max: 2.50, unit: "" }
  },
  'TOTAL BILIRUBIN': {
    conventional: { min: 0.00, max: 1.20, unit: "MG/DL" },
    si:           { min: 0.00, max: 20.52, unit: "UMOL/L" }
  },      
  'DIRECT BILIRUBIN': {
    conventional: { min: 0.00, max: 0.30, unit: "MG/DL" },
    si:           { min: 0.00, max: 5.30, unit: "UMOL/L" }
  },
  'INDIRECT BILIRUBIN': {
    conventional: { min: 0.10, max: 1.00, unit: "MG/DL" },
    si:           { min: 0.00, max: 17.10, unit: "UMOL/L" }
  },  
...
function sanitizeLabInput(text, px_gender = 'Male') {
  ...
  return text
    ...
    .map(line => {
      ...
      const [min, max] = range;
      const isOutlier = normalized === 'HDL CHOLE'
        ? numeric < min
        : numeric < min || numeric > max;

      const tooltip = normalized === 'HDL CHOLE'
        ? `Normal range: 40 and above`
...
function highlightOutliers(labText, px_gender = 'Male') {
  px_gender = (px_gender || 'Male').toLowerCase();
  console.log('🧪 highlightOutliers gender param:', px_gender);
  ...
  return labText.split('\n').map(line => {
    if (!line.trim()) return '';

    let keyRaw, valRaw;
    if (line.includes(':')) {
      [keyRaw, valRaw] = line.split(':').map(s => s.trim());
    } else {
      const parts = line.trim().split(/\s+/);
      keyRaw = parts[0];
      valRaw = parts[1] || '';
    ...
    const normalizedKey = aliases[keyUpper] || keyUpper;

    const val = parseFloat(valRaw);
    const range = refRanges[normalizedKey];

    if (!range || isNaN(val)) return `${normalizedKey}: ${valRaw}`;

    const [min, max] = range;
    const isOutlier = normalizedKey === 'HDL CHOLE'
      ? val < min
      : val < min || val > max;

    const tooltip = normalizedKey === 'HDL CHOLE'
      ? `Normal range: 40 and above`
      : `Normal range: ${min} – ${max}`;

    return isOutlier
      ? `${normalizedKey}: <span style="color:red;" data-bs-toggle="tooltip" title="${tooltip}">${valRaw}</span>`
      : `${normalizedKey}: ${valRaw}`;
  }).join('<br>');
}
...
function updateLabResultHighlights(px_gender = 'Male') {
  document.querySelectorAll('.labresult-highlight').forEach(el => {
    ...
    if (raw) {
      el.innerHTML = highlightOutliers(raw, px_gender);
    }
  });
...
function extractLabValues(text) {
  const refMap = [
    { name: "FBS", useSI: false, aliases: ["FBS"] },
    { name: "BUN", useSI: false, aliases: ["BUN"] },
    { name: "CREATININE", useSI: false, aliases: ["CREATININE"] },
    { name: "URIC ACID", useSI: true, aliases: ["URIC ACID"] },
    { name: "CHOLESTEROL", useSI: false, aliases: ["CHOLESTEROL"] },
    { name: "TRIGLYCERIDES", useSI: false, aliases: ["TRIGLYCERIDES"] },
    { name: "HDL CHOLE", useSI: false, aliases: ["HDL CHOLE", "HDL-CHOLE", "HDL - CHOLE"] },
    { name: "LDL CHOLE", useSI: false, aliases: ["LDL CHOLE", "LDL-CHOLE", "LDL - CHOLE"] },
    { name: "SGOT", useSI: false, aliases: ["SGOT"] },
    { name: "SGPT", useSI: false, aliases: ["SGPT"] },
    { name: "SODIUM", useSI: false, aliases: ["SODIUM"] },
    { name: "POTASSIUM", useSI: false, aliases: ["POTASSIUM"] },
    { name: "HBA1C", useSI: false, aliases: ["HBA1C", "HB A1C"] },
    { name: "LDH", useSI: false, aliases: ["LDH"] },
    { name: "ALK PHOS", useSI: false, aliases: ["ALK PHOS"] },
    { name: "CHLORIDE", useSI: false, aliases: ["CHLORIDE"] },
    { name: "TOTAL PROTEIN", useSI: false, aliases: ["TOTAL PROTEIN"] },
    { name: "ALBUMIN", useSI: false, aliases: ["ALBUMIN"] },
    { name: "GLOBULIN", useSI: false, aliases: ["GLOBULIN"] },
    { name: "A/G RATIO", useSI: false, aliases: ["A/G RATIO"] },
    { name: "TOTAL BILIRUBIN", useSI: false, aliases: ["TOTAL BILIRUBIN"] },
    { name: "DIRECT BILIRUBIN", useSI: false, aliases: ["DIRECT BILIRUBIN"] },
    { name: "INDIRECT BILIRUBIN", useSI: false, aliases: ["INDIRECT BILIRUBIN"] },
    { name: "CALCIUM", useSI: false, aliases: ["CALCIUM"] },
    { name: "GGTP", useSI: false, aliases: ["GGTP"] },
    { name: "PHOSPHORUS", useSI: false, aliases: ["PHOSPHORUS"] },
    { name: "AMYLASE", useSI: false, aliases: ["AMYLASE"] },
    { name: "CK TOTAL", useSI: false, aliases: ["CK TOTAL"] }
  ];

  // Build known units set from referenceData
  const knownUnits = new Set();
  for (const entry of Object.values(referenceData)) {
    knownUnits.add(entry.conventional.unit.toUpperCase());
    knownUnits.add(entry.si.unit.toUpperCase());
  }

  function isReferenceLine(line) {
    const upper = line.toUpperCase();
    const hasRange = /(\d+\.?\d*)\s*[-–]\s*(\d+\.?\d*)/.test(upper) || upper.includes(' TO ');
    const refKeywords = ['REFERENCE', 'RANGE', '%', 'MMOL', 'MG/DL', 'U/L', 'MEQ', 'UMOL', 'GM/L', 'GM/DL'];
    return hasRange || refKeywords.some(k => upper.includes(k));
  }
...
function findValidValue(index, ref) {
  const offsetRange = [-5, -4, -3, -2, -1, 1, 2, 3, 4, 5];
  ...
  for (let offset of offsetRange) {
    ...
    // Filter out anything that looks like a reference line
    if (
      isReferenceLine(trimmed) ||
      upper.includes('%') ||
      upper.includes(' TO ') ||
      upper.includes('MMOL') || upper.includes('MG/DL') ||
      upper.includes('U/L') || upper.includes('RANGE') ||
    ...
    if (nums && nums.length === 1 && !isNaN(nums[0])) {
      candidates.push({
  ...
  // ✅ Pick the largest value among all valid candidates
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    for (const ref of refMap) {
      if (alreadyExtracted.has(ref.name)) continue;

      const matched = ref.aliases.some(alias => normalizedLine.startsWith(normalize(alias)));
      if (!matched) continue;

      let value = findValidValue(i, ref);
      if (value && /^[\d.]+$/.test(value)) {
        results.push(`${ref.name}: ${value}`);
        alreadyExtracted.add(ref.name);
      }
    }
  }
...
function populatePatientInfo() {
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      // Full name
      const suffix = (px.px_suffix && px.px_suffix.toLowerCase() !== 'null') ? px.px_suffix : '';
      const fullName = [px.px_firstname, px.px_midname, px.px_lastname, suffix].filter(Boolean).join(' ');
      ...
      function setDesktopField(fieldId, value) {
        if (fieldId === "pwd") {
          ...
          const displayVal = typeof value === 'object' ? value.display : value;
          const rawVal = typeof value === 'object' ? value.raw : value;
          $('#desktop_civstat_span').html(
  !displayVal || displayVal.toLowerCase() === 'null' ? '' : displayVal
);
...
var tb_pres_history = $('#tb_pres_history').DataTable({  
  ...
  function labResultRenderer(data, type, row) {
    if (!data) return '';
    return `<div class="labresult-highlight" data-raw="${escapeHtml(data)}">${highlightOutliers(data)}</div>`;
  }
...
$('#generate_prescription').click(function () {
    Swal.fire({
        title: 'Are you sure?',
        text: "Generate and send this prescription to the patient's email?",
        icon: 'question',
        ...
        if (result.isConfirmed) {
            Swal.fire({
                title: 'Sending...',
                text: 'Please wait while we generate and send the email.',
            ...
            $.ajax({
                ...
                success: function (data) {
                    Swal.fire({
                        ...
                        location.reload(); // refresh after acknowledgment
                    });
                },
                error: function (xhr, ajaxoption, thrownerror) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Failed',
                        text: 'An error occurred: ' + xhr.status + ' ' + thrownerror
                    });
                }
            });
        }
...
$('#generate_medcert').click(function () {
    Swal.fire({
        title: 'Are you sure?',
        text: "Generate and send this to the patient's email?",
        icon: 'question',
        showCancelButton: true,
        confirmButtonText: 'Yes, send it!',
        cancelButtonText: 'Cancel'
            ...
            $.ajax({
                ...
                success: function (data) {
                    Swal.fire({
                        ...
                        location.reload(); // reload only after user closes Swal
                    });
                },
                error: function (xhr, ajaxoption, thrownerror) {
                    Swal.fire({
...
$('#generate_labtest').click(function () {
    Swal.fire({
        title: 'Are you sure?',
        text: "Generate and send this lab result to the patient's email?",
        icon: 'question',
        showCancelButton: true,
        confirmButtonText: 'Yes, send it!',
        cancelButtonText: 'Cancel'
...
$('#generate_appointment').click(function () {
  Swal.fire({
    title: 'Are you sure?',
    text: "Generate and send the appointment details to the patient's email?",
    icon: 'question',
    showCancelButton: true,
    confirmButtonText: 'Yes, send it!',
    cancelButtonText: 'Cancel'
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 🔍 Extract lab values from OCR text using known reference ranges
...
console.log('🧪 Extracted values:\n', extracted);
  ...
  document.getElementById('submit_diagnosis')?.addEventListener('click', () => {
    ...
    // ✅ Step 1: standardize aliases and format
    const sanitized = sanitizeLabInput(raw, gender);

    // ✅ Step 2: apply outlier highlights using gender-specific ranges
