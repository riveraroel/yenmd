...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function extractLabValues(text) {
    const refMap = [
      ...
      { name: "HDL CHOLE", useSI: false, aliases: ["HDL CHOLE", "HDL-CHOLE"] },
      { name: "LDL CHOLE", useSI: false, aliases: ["LDL CHOLE", "LDL-CHOLE"] },
      ...
      { name: "FT3", useSI: false, aliases: ["FT3"] },
      { name: "FT4", useSI: false, aliases: ["FT4"] },
      { name: "TSH", useSI: false, aliases: ["TSH"] },
      { name: "VITAMIN D", useSI: false, aliases: ["VITAMIN D"] }        
    ...
    for (let i = 1; i < lines.length; i++) {
      ...
      for (const ref of refMap) {
        ...
        const val1 = lines[i - 1]?.match(/[\d.]+/)?.[0];
        const val2 = lines[i - 2]?.match(/[\d.]+/)?.[0];
        const value = ref.useSI ? val2 || val1 : val1 || val2;
