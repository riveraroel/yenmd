...
document.addEventListener('DOMContentLoaded', () => {
  ...
  waitForPDFJS(() => {
    ...
    function updatePDFControls() {
      document.getElementById('pdfPrev').disabled = currentPage <= 1;
      document.getElementById('pdfNext').disabled = currentPage >= totalPages;
    }
...
if (saveBtn) {
  ...
  function extractLabValues(text) {
    ...
    // (Special keyword + test value extraction stays unchanged...)
    // --- Keep your existing logic for extracting values ---
    // (I didn’t modify this section since no duplicates)
  ...
  document.getElementById('uploadLabImage')?.addEventListener('click', () => input?.click());
