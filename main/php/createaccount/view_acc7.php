...
<body>
    ...
    <nav class='navbar justify-content-center'>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <button class="nav-link" id="nav-issued_labs-tab" data-bs-toggle="tab" data-bs-target="#nav-issued_labs" type="button" role="tab" aria-controls="nav-issued_labs" aria-selected="false">Issued Labs</button>
        </div>
    </nav>
