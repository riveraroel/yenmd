...
<body>
  ...
  <div class="collapse navbar-collapse sticky-top bg-white border-bottom shadow-sm" id="tabNavCollapse" style="z-index: 1020;">
    <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
      ...
      <button class="nav-link" id="nav-issued_diagnosis-tab" data-bs-toggle="tab" data-bs-target="#nav-issued_diagnosis" type="button" role="tab">Issued Diagnoses</button>
      <button class="nav-link" id="nav-issued_appointment-tab" data-bs-toggle="tab" data-bs-target="#nav-issued_appointment" type="button" role="tab">Booked Appointments</button>
      <button class="nav-link" id="nav-issued_prescription-tab" data-bs-toggle="tab" data-bs-target="#nav-issued_prescription" type="button" role="tab">Issued Prescriptions</button>
      <button class="nav-link" id="nav-issued_labs-tab" data-bs-toggle="tab" data-bs-target="#nav-issued_labs" type="button" role="tab">Ordered Labs</button>
      <button class="nav-link" id="nav-uploaded_images-tab" data-bs-toggle="tab" data-bs-target="#nav-uploaded_images" type="button" role="tab">Uploaded Lab Results</button>
    </div>
  </div>
                        ...
                        <table id="tb_uploaded_images" class="table table-striped" style="width:100%">
                            ...
                            <tbody id ='tb_uploaded_images2'>
                                <?php
                                    ...
                                    while ($row = $res->fetch_assoc())
                                    {
                                        // Convert timestamp to Asia/Manila
                                        $date = new DateTime($row['upldate'], new DateTimeZone('UTC')); // adjust 'UTC' if DB stores in another timezone
                                        $date->setTimezone(new DateTimeZone('Asia/Manila'));
                                        $formattedDate = $date->format('Y-m-d H:i:s');
                                    
                                        echo "<tr id='".$row['uplid']."'>";
                                            echo "<td>".$row['fullname']."</td>";
                                            echo "<td>".($row['upllabtype'] ?? 'Untagged')."</td>";
