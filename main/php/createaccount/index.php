...
<ul class="nav nav-tabs" id="px-tab" role="tablist">
  ...
  <li class="nav-item" role="presentation">
    <a class="nav-link active" id="acclist-tab" data-bs-toggle="tab" data-bs-target="#acclist-tab-pane" type="button" role="tab" aria-controls="acclist-tab-pane" aria-selected="true">
      <i class="bi bi-card-list me-2"></i>User Accounts List
    </a>
  </li>

  <li class="nav-item" role="presentation">
    <a class="nav-link text-success" id="addacc-tab" data-bs-toggle="tab" data-bs-target="#addacc-tab-pane" type="button" role="tab" aria-controls="addacc-tab-pane" aria-selected="false">
      <i class="bi bi-person-add me-2"></i>Add User Account
    </a>
  </li>
    ...
    <form id="addacc-form" class="container py-3" autocomplete="off">
        <div class="row g-3">
            ...
            <div class="col-md-4 col-sm-12">
                <label for="addacc_licno"><p>PTR:</p></label>
                <input type="text" class="form-control" name="addacc_ptr">
            </div>
            <div class="col-md-4 col-sm-12">
                <label for="addacc_licno"><p>S2:</p></label>
                <input type="text" class="form-control" name="addacc_s2">
            </div>
            <div class="col-md-4 col-sm-12">
