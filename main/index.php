...
<nav class="navbar navbar-expand-lg navbar-light bg-light rounded-3 px-0 sticky-top shadow-sm">
    ...
    <img src="../favicon/banner.png" alt="Yen MD logo" style="height: 50px;" class="img-fluid">
        ...
        <ul class="navbar-nav nav nav-pills ms-auto text-end flex-lg-row flex-column align-items-lg-center align-items-end" id="pills-tab" role="tablist">
            ...
            <button class="nav-link active text-primary fw-semibold" id="pills-apt_calendar-tab" data-bs-toggle="pill" data-bs-target="#pills-apt_calendar" type="button" role="tab" aria-controls="pills-apt_calendar" aria-selected="true">
                <i class="bi bi-calendar-event me-2"></i>Appointment Calendar
            </button>
            </li>

            <li class="nav-item" role="presentation">
            <button class="nav-link text-primary fw-semibold" id="pills-px_profile-tab" data-bs-toggle="pill" data-bs-target="#pills-px_profile" type="button" role="tab" aria-controls="pills-px_profile" aria-selected="false">
                <i class="bi bi-person-lines-fill me-2"></i>Patients
            </button>
            </li>

            <li class="nav-item" role="presentation">
            <button class="nav-link text-primary fw-semibold" id="pills-createacc-tab" data-bs-toggle="pill" data-bs-target="#pills-createacc" type="button" role="tab" aria-controls="pills-createacc" aria-selected="false">
                <i class="bi bi-person-plus me-2"></i>User Account
            </button>
            </li>

            <li class="nav-item" role="presentation">
            <button class="nav-link text-primary fw-semibold" id="pills-logout-tab" type="button" role="tab">
...
<div class="tab-content border rounded-3 border-primary p-3 mt-3" id="pills-tabContent">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="notifierBannerLabel">Yen MD</h1>
    ...
    <div id = 'loadingModal' class = "modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog">
        <div class = 'modal-dialog modal-dialog-centered modal-lg' role="document">
            <div class="modal-content">
                <div class = 'modal-header'>
                    <h4 class = 'modal-title'>Yen MD</h4>
                </div>
